...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("D:\\EclipseWorkstationForHome\\JavaTraining\\MavenTest\\src"+
	...
	public static void initialization() {
		...
		if(browserName.contains("chrome")) {
			System.setProperty("webdriver.chrome.driver", "D:\\EclipseWorkstationForHome\\"
		                                                   +"chromedriver-win64_128.0.6613.119\\chromedriver.exe");
